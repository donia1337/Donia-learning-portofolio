# This script should be able to read a website and save an url that holds json data.
# For this example we are using: https://www.swpc.noaa.gov/products/aurora-30-minute-forecast
